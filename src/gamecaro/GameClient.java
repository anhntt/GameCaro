...
public class GameClient extends javax.swing.JFrame implements ActionListener {
    ...
    private void socketClient() {
        ...
        try {
            ...
            socket = new Socket("localhost", 2222); // connect Server
                ...
                while (true) {
                    try {
                        ...
                        if (data[0].equals("chat")) {
                            jTextAreaTextChat.append("Server: " + data[1] + '\n');
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jTextFieldTextChat, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
